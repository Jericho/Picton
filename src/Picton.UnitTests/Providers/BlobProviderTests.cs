...
namespace Picton.Providers.UnitTests
{
	...
	public class BlobProviderTests
	{
		...
		public void Null_queueName_throws()
		{
			...
			var blobProvider = new BlobProvider(null, storageAccount.Object);
		}
		...
		{
			var storageAccount = new Mock<IStorageAccount>(MockBehavior.Strict);
			var blobProvider = new BlobProvider("", storageAccount.Object);
		}
		...
		public void Null_IStorageAccount_throws()
		{
			...
			var blobProvider = new BlobProvider("mycontainer", storageAccount);
		}
		...
		public void Initialization()
		{
			...
			// Act
			var blobProvider = new BlobProvider(containerName, storageAccount.Object);
		...
		//	// Act
		//	var blobProvider = new BlobProvider(containerName, storageAccount.Object);
		//	var result = blobProvider.GetBlobContentAsync(blobName, CancellationToken.None);
		//	result.Wait();
		...
		//	// Act
		//	var blobProvider = new BlobProvider(containerName, storageAccount.Object);
		//	var result = blobProvider.GetBlobContentAsync(blobName);
		//	result.Wait();

...
// Install tools.
#tool nuget:?package=GitVersion.CommandLine&version=5.2.2
...
var testCoverageFilter = "+[Picton]* -[Picton]Picton.Properties.* -[Picton]Picton.Models.* -[Picton]Picton.Logging.*";
